    ...
    base.methods = {
      init: function () {
        ...
        $(document).on('click', '.answers a', function (e) {
          ...
          e.preventDefault();
          var qu = $('.question').text();
          var stringarr = { "Q": qu, "Studentanswer": this.outerText };
          listofanswers.push(JSON.stringify(stringarr));
      ...
      finish: function () {
        ...
        $('#quiz-finalscore').val(score);
        document.cookie = 'listofanswers=' + listofanswers + '';
